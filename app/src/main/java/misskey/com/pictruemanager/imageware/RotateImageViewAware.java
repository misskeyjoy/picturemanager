 ...
 *******************************************************************************/
package misskey.com.pictruemanager.imageware;
...
import misskey.com.pictruemanager.utils.BitmapUtil;
...
public class RotateImageViewAware implements ImageAware {
	...
	/**
	 * Constructor. <br />
	 * References {@link #(ImageView, boolean) ImageViewAware(imageView, true)}.
	 *
